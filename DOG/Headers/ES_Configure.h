...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "I2C_Service.h"
// the name of the Init function
#define SERV_2_INIT Init_I2C
// the name of the run function
#define SERV_2_RUN Run_I2C
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "DogMasterSM.h"
// the name of the Init function
#define SERV_3_INIT InitDogMasterSM
// the name of the run function
#define SERV_3_RUN RunDogMasterSM
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_BYTE_RECEIVED,
								...
								ES_LEFT_SERVO_UP,
								ES_LEFT_SERVO_DOWN,
								ES_LEFT_SERVO_UP_INCR,
								ES_LEFT_SERVO_UP_DECR,
								ES_LEFT_SERVO_DOWN_INCR,
								ES_LEFT_SERVO_DOWN_DECR,
								ES_RIGHT_SERVO_UP,
								ES_RIGHT_SERVO_DOWN,
								ES_RIGHT_SERVO_UP_INCR,
								ES_RIGHT_SERVO_UP_DECR,
								ES_RIGHT_SERVO_DOWN_INCR,
								ES_RIGHT_SERVO_DOWN_DECR,
								ES_BRAKES_UP,
								ES_BRAKES_DOWN,
